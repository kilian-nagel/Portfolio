...
const parts3 = [
	{
		...
		content:"A travers des cas lors de TD en cours, j'ai appris à identifier les divers obstacles pouvant amenuir les chances de réussite d'un projet informatique. De plus lors d'interview que nous avons effectué en groupe nous avons pu avoir une idée plus concrète de ces éléments là."
	},
	{
